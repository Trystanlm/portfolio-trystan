...
<div class="container bordered-container mt-4">
    ...
    <div class="text-center mb-4">
        <img src="./assets/img/logo_startdev.png" alt="Logo Sectronic" class="img-fluid" style="max-width: 200px;">
        <img src="./assets/img/logo_biodice.png" alt="Logo Sectronic" class="img-fluid" style="max-width: 200px;">
    </div>

    <!-- Titre et présentation -->
    <h1 class="fw-bold text-center mb-4 text-gradient">BioDicé</h1>
